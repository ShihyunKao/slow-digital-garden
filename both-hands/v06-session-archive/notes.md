...
- Anchor direction follows a fixed golden-angle sequence with a small correction from signed hand tilt.
...
- Golden-angle anchor placement and local star clusters
- Predetermined cross-ring connections and final body-map signature

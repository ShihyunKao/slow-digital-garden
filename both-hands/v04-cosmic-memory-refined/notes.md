...
## Interaction
Select **Begin** to activate the camera. Move two hands apart to open the field. After reaching a wide stretch, bring them back together to leave one orbit-like memory ring. Each completed cycle places the next ring closer to the centre.

## Testing focus
- Can a visitor understand the small-to-large range without explanation?
- Does the skeleton mode help during testing without becoming part of the final visual?
- Is the quieter default screen more exhibition-like?

## Keys
- `?`: show / hide help
- `P`: Points → Skeleton → Hidden
- `R`: clear memory rings

(() => {
  const studies = {
    ...
    "open/v02-layered-bloom/variants/v02.01": ["01", "OPEN", "02.01", "Topographic Tissue", "open", "v02-topographic", "P HAND DISPLAY · ? HELP", "../../../../"],
    "open/v02-layered-bloom/variants/v02.02": ["01", "OPEN", "02.02", "Phase Bloom", "open", "v02-phase", "P HAND DISPLAY · ? HELP", "../../../../"],
    "open/v03-palm-imprint": ["01", "OPEN", "03.00", "Palm Imprint", "open", "v03", "P HAND DISPLAY · R RESET · ? HELP"],
    "open/v03-palm-imprint/variants/v03.01": ["01", "OPEN", "03.01", "Dust Negative", "open", "v03-dust-negative", "P HAND DISPLAY · R RESET · ? HELP", "../../../../"],
    "open/v03-palm-imprint/variants/v03.02": ["01", "OPEN", "03.02", "Cyanotype Exposure", "open", "v03-cyanotype", "P HAND DISPLAY · R RESET · ? HELP", "../../../../"],
    "open/v04-calibrated-imprint": ["01", "OPEN", "04.00", "Held Imprint", "open", "v04", "P HAND DISPLAY · R RESET · ? HELP"],
    "open/v04-calibrated-imprint/variants/v04.01": ["01", "OPEN", "04.01", "Embossed Seal", "open", "v04-embossed-seal", "P HAND DISPLAY · R RESET · ? HELP", "../../../../"],
    "open/v04-calibrated-imprint/variants/v04.02": ["01", "OPEN", "04.02", "Thermal Plate", "open", "v04-thermal-plate", "P HAND DISPLAY · R RESET · ? HELP", "../../../../"],
    "open/v05-pressure-bloom": ["01", "OPEN", "05.00", "Pressure Bloom", "open", "v05", "P HAND DISPLAY · R RESET · ? HELP"],
    "open/v05-pressure-bloom/variants/v05.01": ["01", "OPEN", "05.01", "Liquid Lens", "open", "v05-liquid-lens", "P HAND DISPLAY · R RESET · ? HELP", "../../../../"],
    "open/v05-pressure-bloom/variants/v05.02": ["01", "OPEN", "05.02", "Acoustic Compression", "open", "v05-acoustic-compression", "P HAND DISPLAY · R RESET · ? HELP", "../../../../"],
    "open/v06-finger-constellation": ["01", "OPEN", "06.00", "Finger Constellation", "open", "v06", "P HAND DISPLAY · R RESET · ? HELP"],
    "open/v06-finger-constellation/variants/v06.01": ["01", "OPEN", "06.01", "Thread Cartography", "open", "v06-thread-cartography", "P HAND DISPLAY · R RESET · ? HELP", "../../../../"],
    "open/v06-finger-constellation/variants/v06.02": ["01", "OPEN", "06.02", "Mineral Archive", "open", "v06-mineral-archive", "P HAND DISPLAY · R RESET · ? HELP", "../../../../"],

...
const heldImprintVariant = window.OPEN_V03_VARIANT || null;
...
function drawHelpScreen() {
  ...
  noStroke(); textAlign(LEFT, TOP); fill(174, 191, 166, 180); textSize(11); text("GESTURE STUDY 03.00", left, panel.y + (compact ? 25 : 38));
  ...
  fill(174, 191, 166, 135); textSize(11); text("P  HAND DISPLAY     R  RESET     ?  HELP", left, panel.buttonY - (compact ? 31 : 40));
...
function keyPressed() {
  ...
  if (showHelp && (keyCode === ENTER || key === " " || keyCode === ESCAPE)) { beginExperience(); return false; }

...
## What to observe
- Does the visual trace feel calm and intentional?
- Is the difference between fast and slow movement noticeable?
- Does the result feel like a personal movement record?

## Next possible development
Use the accumulated drawing as the base layer of a garden, then let later gestures introduce seasonal colour, light, or sound.
